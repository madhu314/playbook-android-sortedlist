...
public class SortedListMoveArticleFragment extends Fragment {
  ...
  private SortedListMoveArticleAdapter adapter;

  public static SortedListMoveArticleFragment create() {
    return new SortedListMoveArticleFragment();
  }
  ...
  @Nullable @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    adapter = new SortedListMoveArticleAdapter(articleList);
